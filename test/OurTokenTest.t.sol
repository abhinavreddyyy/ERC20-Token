...
contract OurTokenTest is Test {
    ...
    function testAllowancesWorks() public {
        ...
        // If you use only transfer, then whoever calls the function is the msg.sender. so the transfer will automatically sets the from as whoever is sending the message
